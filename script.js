...
function setupPageTransition() {
    ...
    transition.innerHTML = `
        <div class="transition-layer transition-back"></div>
        <div class="transition-layer transition-middle"></div>
        <div class="transition-layer transition-front">
            <div class="transition-logo">🍫 BROWNIES</div>
        </div>
    `;
    ...
    document.querySelectorAll("a[href]").forEach(link => {
        link.addEventListener("click", event => {
            ...
            if (transition.classList.contains("is-leaving")) {
                return;
            }
